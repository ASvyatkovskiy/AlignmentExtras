...
#APEs = {"x":([0,0.01,0.02,0.03],[0,0.02,0.03,0.04]),"y":([0,0.05,0.07,0.1],[0,0.01,0.02,0.03]),"z":([0,0.05,0.08,0.1],[0,0.4,0.5,0.6]),"Phix":([0,0.0001,0.0003,0.0005],[0,0.008,0.01,0.012]),"Phiy":([0,0.001,0.0015,0.003],[0,0.020,0.027,0.032]),"Phiz":([0,0.0002,0.0004,0.0006],[0,0.0002,0.0004,0.0006])} # (DT,CSC) tuple of lists

#v2
#Sigmas = {"x":(0.02,0.03),"y":(0.07,0.02),"z":(0.08,0.8),"Phix":(0.0003,0.01),"Phiy":(0.0015,0.02),"Phiz":(0.0004,0.0004)} # (DT,CSC) tuple
#APEs = {"x":([0,0.001,0.005,0.008],[0,0.002,0.006,0.008]),"y":([0,0.05,0.07,0.1],[0,0.01,0.02,0.03]),"z":([0,0.05,0.08,0.1],[0,0.4,0.5,0.6]),"Phix":([0,0.0001,0.0003,0.0005],[0,0.008,0.01,0.012]),"Phiy":([0,0.003,0.005,0.008],[0,0.020,0.027,0.032]),"Phiz":([0,0.0008,0.001,0.005],[0,0.0002,0.0004,0.0006])} # (DT,CSC) tuple of lists

#v3
#Sigmas = {"x":(0.02,0.03),"y":(0.07,0.05),"z":(0.08,1.0),"Phix":(0.0003,0.01),"Phiy":(0.0015,0.05),"Phiz":(0.0004,0.0007)} # (DT,CSC) tuple
#APEs = {"x":([0,0.0001,0.0005,0.0008],[0,0.0002,0.0006,0.0008]),"y":([0,0.05,0.07,0.1],[0,0.01,0.02,0.03]),"z":([0,0.05,0.08,0.1],[0,0.4,0.5,0.6]),"Phix":([0,0.0008,0.001,0.01],[0,0.01,0.05,0.1]),"Phiy":([0,0.01,0.03,0.08],[0,0.020,0.027,0.032]),"Phiz":([0,0.008,0.01,0.05],[0,0.0002,0.0004,0.0006])} # (DT,CSC) tuple of lists

#v4
#Sigmas = {"x":(0.02,0.03),"y":(0.1,0.2),"z":(0.08,1.0),"Phix":(0.0003,0.01),"Phiy":(0.0015,0.05),"Phiz":(0.0004,0.0007)} # (DT,CSC) tuple
#APEs = {"x":([0,0.0001,0.0004,0.001],[0,0.0001,0.0009,0.0015]),"y":([0,0.005,0.01,0.08],[0,0.01,0.04,0.1]),"z":([0,0.001,0.006,0.05],[0,0.5,1.0,2.0]),"Phix":([0,0.00000008,0.001,0.01],[0,0.00000001,0.05,0.1]),"Phiy":([0,0.01,0.03,0.08],[0,0.020,0.027,0.032]),"Phiz":([0,0.00000008,0.01,0.1],[0,0.0000005,0.0004,0.004])} # (DT,CSC) tuple of lists

#v5
#Sigmas = {"x":(0.02,0.03),"y":(0.1,0.2),"z":(0.08,1.0),"Phix":(0.0008,0.08),"Phiy":(0.001,0.05),"Phiz":(0.0001,0.0007)} # (DT,CSC) tuple
#APEs = {"x":([0,0.0001,0.0004,0.001],[0,0.0001,0.0009,0.0015]),"y":([0,0.005,0.01,0.08],[0,0.01,0.04,0.1]),"z":([0,0.001,0.006,0.05],[0,0.5,1.0,2.0]),"Phix":([0,0.0008,0.001,0.01],[0,0.01,0.05,0.1]),"Phiy":([0,0.000002,0.03,0.08],[0,0.002,0.03,0.08]),"Phiz":([0,0.008,0.01,0.05],[0,0.0002,0.0004,0.0006])} # (DT,CSC) tuple of lists

#final round
Sigmas = {"x":(0.02,0.03),"y":(0.1,0.2),"z":(0.08,1.0),"Phix":(0.0003,0.01),"Phiy":(0.001,0.025),"Phiz":(0.0001,0.0004)}
APEs = {'y': ([0,0.0025000000000000005, 0.010000000000000002, 0.04000000000000001, 1.0], [0,0.010000000000000002, 0.04000000000000001, 0.16000000000000003, 4.0]), 'x': ([0,0.0001, 0.0004, 0.0016, 0.04000000000000001], [0,0.000225, 0.0009, 0.0036, 0.09]), 'z': ([0,0.0016, 0.0064, 0.0256, 0.6400000000000001], [0,0.25, 1.0, 4.0, 100.0]), 'Phiz': ([0,2.5e-09, 1e-08, 4e-08, 1e-06], [0,4e-08, 1.6e-07, 6.4e-07, 1.6e-05]), 'Phiy': ([0,2.5e-07, 1e-06, 4e-06, 0.0001], [0,0.00015625000000000003, 0.0006250000000000001, 0.0025000000000000005, 0.0625]), 'Phix': ([0,2.2499999999999996e-08, 8.999999999999999e-08, 3.5999999999999994e-07, 8.999999999999999e-06], [0,2.5e-05, 0.0001, 0.0004, 0.010000000000000002])}
    ...
    for dof in Sigmas.keys():
        ...
        for iline in range(length):
            if input_file[iline].find('setape') != -1:
                APE = apesDT
                if input_file[iline-2].find('CSC') != -1:
                    APE = apesCSC
