...
for dof in dofs:
    for scenario in Scenarios:
        ...
        #CSC
        APEs[dof][1].append((pow(Sigmas[dof][1]*scenario,2)))

#APEs = {'y': ([0,0.0025, 0.010, 0.040, 1.0], [0,0.010, 0.040, 0.160, 4.0]), 'x': ([0,0.0001, 0.0004, 0.0016, 0.040], [0,0.000225, 0.0009, 0.0036, 0.09]), 'z': ([0,0.0016, 0.0064, 0.0256, 0.640], [0,0.25, 1.0, 4.0, 100.0]), 'Phiz': ([0,2.5e-09, 1e-08, 4e-08, 1e-06], [0,4e-08, 1.6e-07, 6.4e-07, 1.6e-05]), 'Phiy': ([0,2.5e-07, 1e-06, 4e-06, 0.0001], [0,0.00015625, 0.000625, 0.0025, 0.0625]), 'Phix': ([0,2.25e-08, 9e-08, 3.6e-07, 9e-06], [0,2.5e-05, 0.0001, 0.0004, 0.01])}
